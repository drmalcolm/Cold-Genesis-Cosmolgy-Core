...
This repository hosts the official, open-source computational verification package for **Cold Genesis Cosmology: A Superfluid, Thermodynamic Origin of Cosmic Structure**. 
